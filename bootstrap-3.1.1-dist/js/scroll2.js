...
// optionally add the class .toggleDiv to each div you want to automatically close
                      $('.toggleDiv2:hidden').slideUp(options.speed, options.easing);
...
$(document).ready(function(){
   ...
   $('.show_hide2').showHide({
        ...
        showText: 'See More',// the button text to show when a div is closed
        hideText: 'See Less' // the button text to show when a div is open
